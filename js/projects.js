export const languages = {
    ...
    wordpress: `<img src="./icons/ico-wordpress.svg" alt="wordpress">`,
}
...
export const projects = [
    ...
    },
    {
        ...
        desciption: "Para este proyecto, me desempeñé como auxiliar del equipo de trabajo Character TEAM, donde el principal objetivo es la renovación, desarrollo y diseño de la nueva página web de la Universidad Industrial de Santander.",
        language: [
            languages.html,
            languages.css,
            languages.javascript,
    ...
    {
        tittle: "Aprendiz Analista de Datos Mibanco",
        bgUrl: "../images/img-project.webp",
        desciption: "Extracción, Transformación y Carga (ETL) de informacion por medio de Python, Excel y Power BI para analizar, preveer y mitigar los incumplimientos en los lineamientos para la ortorgación de crédito.",
        language: [
            languages.python,
        ],
    },
